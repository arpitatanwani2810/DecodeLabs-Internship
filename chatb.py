...
def run_chatbot():
    responses = {
       "hello": "Hey there, human! Glad you dropped by. Ready to look at some clean code?",
        ...
        "weather": "Current terminal environment is a perfect 22°C with a 100% chance of high data throughput and zero rain.",
        ...
        "schedule": "Today's schedule is to complete the project 1 for Decode Labs",
    ...
    while True:
        ...
        # The Professional Approach: Atomic Operation (Lookup + Fallback)
        default_fallback = (
